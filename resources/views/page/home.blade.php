                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="section-heading1 text-left">
                            <h3>NHỮNG MÓN ĂN VẶT<span>Xem thêm</span></h3>  
                        </div>
        ...
        <section class="best-receipe-area">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="section-heading1 text-left">
                                <h3>NHỮNG MÓN ĂN VÀO DỊP LỄ HỘI<span>Xem thêm</span></h3>  
                            </div>
            ...
            <section class="best-receipe-area">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="section-heading1 text-left">
                                    <h3>NHỮNG MÓN ĂN GIẢM CÂN<span>Xem thêm</span></h3>  
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-best-receipe-area mb-30">
                            ...
                            <div class="receipe-content">
                                <a href="receipe-post.html">
                                    <h5 class="text-left ">Tái hiện lại 5 món ăn đặc trưng Hàn Quốc chuẩn nhất </h5>
                                </a>
                                <p class="text-left ">Khám phá ẩm thực</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-lg-3">
